...
\usepackage{microtype} % Character protrusion/font expansion to fix right-margin overfull hboxes
\setlength{\emergencystretch}{3em} % Extra line-breaking slack to eliminate remaining overfull hboxes
...
\begin{document}
\normalsize
\rhead{\textcolor{ashgrey}{Deepakraj Rajmohan, MSc dissertation}}
